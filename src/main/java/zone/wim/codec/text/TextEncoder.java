...
public abstract class TextEncoder extends Encoder {
    ...
    @Override
    protected CoderResult encodeLoop(Object in, ByteBuffer out) {
        try {
            CharBuffer charIn = (CharBuffer)in;
            return encodeLoop(charIn, out);
        } catch (ClassCastException cce) {
            throw new IllegalArgumentException("Text encoders must have CharBuffer inputs", cce);
        }
    }
    ...
    {
        int n = (int)(in.remaining() * textCodec.averageBytesPerChar());
