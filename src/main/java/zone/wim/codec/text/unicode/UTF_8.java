...
import zone.wim.codec.text.TextEncoder;
...
public final class UTF_8 extends UnicodeCodec {
    ...
    public static String CANONICAL_NAME = "utf8";
    public static String[] ALIASES = {"UTF-8", "u8"};
    ...
    public Decoder decoder() {
        return new Decoder(this, UnicodeCodec.DEFAULT_REPLACEMENT_CHARS);
    }

    @Override
    public Encoder encoder() {
        return new Encoder(this, UnicodeCodec.DEFAULT_REPLACEMENT_BYTES);
    }
