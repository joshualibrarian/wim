...
public abstract class CharsetDecoder extends Decoder {
    ...
    private static final int ST_ESCAPED = 4;

    private int state = ST_RESET;

    private static String stateNames[]
        = { "RESET", "CODING", "CODING_END", "FLUSHED", "ESCAPED" };

    // Optional array of escape characters
    private int[] escapeChars = null;
    ...
    /** Can be used in the decode loops by implementations to 
